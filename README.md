...
**AI-powered dispute resolution and prediction markets, built on GenLayer.**
...
This project is called LegxusAI, not NexusAI — the name was changed early on to avoid clashing with existing projects already using that name in the space.
